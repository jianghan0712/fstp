...
class QNSRespondBO_OTW(ICommon_OTW):
    ...
    def toString(self):
        return "QNSRespondBO_OTW ["+"servername = " + str(self.getServername()) +"," +"respond = " + str(self.getRespond()) +"," +"uuid = " + str(self.getUuid()) +"," +"boid = " + str(self.getBoid()) +"," +"destination = " + str(self.getDestination()) +"," +"]"
