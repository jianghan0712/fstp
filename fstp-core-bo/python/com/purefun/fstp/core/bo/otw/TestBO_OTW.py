...
class TestBO_OTW(ICommon_OTW):
    ...
    def toString(self):
        return "TestBO_OTW ["+"servername = " + str(self.getServername()) +"," +"msg = " + str(self.getMsg()) +"," +"uuid = " + str(self.getUuid()) +"," +"boid = " + str(self.getBoid()) +"," +"destination = " + str(self.getDestination()) +"," +"]"
